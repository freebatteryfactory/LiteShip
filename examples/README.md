...
| 3 · cast to the GPU | [`showcase/`](./showcase) | drive a WGSL shader uniform from a boundary (plus workers, streaming, LLM, and **graph-native stream recovery** at `/stream-recovery` — emit → attest → replay) |
