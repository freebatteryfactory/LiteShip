 ...
 */
import { SignalInput, sealGraph, nodeFromParts } from '@liteship/core';
...
export const node = (input: string): SignalNode =>
  nodeFromParts({ _tag: 'DocGraphSignalNode', _version: 1, family: 'signal', meta: META, input: SignalInput(input) });
