...
import { documentGraphAddressCapsule } from '../../packages/core/src/authoring/capsules/document-graph-address.js';
...
bench(`core.document-graph.address — run() over canonical samples`, () => {
