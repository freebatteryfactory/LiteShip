...
describe('web runtime primitives', () => {
  ...
  test('covers morph hint parsing, validation, and remapping', () => {
    ...
    expect(rejection).toEqual({
      ...
      reason:
        'Morph rejected: elements [missing-id] were required by a preserve hint but are missing from the new HTML. Keep these data-czap-id elements in the server response, or drop them from the preserve hint.',
    });
