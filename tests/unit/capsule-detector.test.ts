...
describe('detectCapsuleCalls', { timeout: scaledTimeout(90_000), hookTimeout: scaledTimeout(90_000) }, () => {
  let allCalls: ReturnType<typeof detectCapsuleCalls>;

  beforeAll(() => {
    allCalls = detectCapsuleCalls([CANONICAL_CBOR, ASSETS_SCENE, BEAT_MARKERS, EXPORT_LIST_FIXTURE]);
  });
