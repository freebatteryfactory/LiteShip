...
const M = [
  ...
  ['S-TOOL: invocation decorrelates', SV('07_tool'),
    ...
    "  readonly invoke: <Tool extends ToolId>(\n    request: ToolInvocationRequest<Tool>,\n  ) => Result<ToolExecution<ToolId>, NonEmptyTuple<Diagnostic>>;"],
  ...
  ['H-MEDIA: render decorrelates from its request', SV('10_media'),
    ...
    "  ) => Result<ServerMediaJob<SchemaId, ToolId, FilesystemRootId, FilesystemRootId, MediaJobId>, NonEmptyTuple<Diagnostic>>;"],
  ['H-MEDIA: the output stream forgets its job', SV('10_media'),
    ...
    "export interface MediaOutputStream<Id extends MediaJobId> {\n  readonly job: MediaJobReference;"],
  ['H-MEDIA: the request erases its input stream', SV('10_media'),
    "  readonly input: FileStream<In>;\n  readonly destination: AdmittedPath<Out>;\n}",
    "  readonly input: FileStream<FilesystemRootId>;\n  readonly destination: AdmittedPath<Out>;\n}"],
