...
// clamp every budget to the 240s floor, and CZAP_TEST_TIMEOUT_SCALE lets a
...
// CZAP_COVERAGE for per-test scaledTimeout(...) calls.
//
...
export default defineConfig({
  ...
  test: {
    ...
    env: { CZAP_COVERAGE: coverageEnabled ? '1' : '0' },
