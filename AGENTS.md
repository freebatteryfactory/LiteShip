...
| --- | --- | ---: | --- |
| `quick` | The current application or changed repository surface is locally coherent. | 5 | `check/format`, `check/lint-structural`, `check/lint`, `check/typecheck`, `check/app-build` |
| `full` | The whole repository is globally coherent. | 20 | `check/format`, `check/lint-structural`, `check/lint`, `check/typecheck`, `check/docs`, `check/gates`, `check/audit-floor`, `check/test`, `check/test-redteam`, `check/runtime-gate`, `check/standards-gate`, `check/capability-gate`, `check/spine-relation-gate`, `check/transition-gate`, `check/plumb-gate`, `check/feedback-verify`, `check/flex-verify`, `check/devx`, `check/capsule-verify`, `check/audit` |
| `release` | Every supported package, platform, artifact, and evidence lane is releasable. | 41 | `check/format`, `check/lint-structural`, `check/lint`, `check/typecheck`, `check/docs`, `check/gates`, `check/audit-floor`, `check/test`, `check/test-redteam`, `check/runtime-gate`, `check/standards-gate`, `check/capability-gate`, `check/spine-relation-gate`, `check/transition-gate`, `check/plumb-gate`, `check/feedback-verify`, `check/flex-verify`, `check/devx`, `check/capsule-verify`, `check/audit`, `check/report-runtime-seams`, `check/report-adaptive-scan`, `check/test-vite`, `check/test-astro`, `check/test-cloudflare`, `check/test-cloudflare-dev`, `check/test-tailwind`, `check/test-e2e`, `check/test-e2e-stress`, `check/test-e2e-stream-stress`, `check/test-flake`, `check/bench`, `check/bench-gate`, `check/bench-trend`, `check/bench-reality`, `check/bench-alloc`, `check/coverage`, `check/package-smoke`, `check/doctor`, `check/journey`, `check/hermetic` |
