...
Defined in: [command/src/commands/package-smoke-registry.ts:88](https://github.com/heyoub/LiteShip/blob/main/packages/command/src/commands/package-smoke-registry.ts#L88)
