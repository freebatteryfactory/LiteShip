...
Defined in: [command/src/commands/check-invariants.ts:54](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/commands/check-invariants.ts#L54)
