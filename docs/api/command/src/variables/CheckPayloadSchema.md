...
[LiteShip](../../../README.md) / [command/src](../README.md) / CheckPayloadSchema
...
`findings` ARE plain JSON-serializable [Finding](../../../liteship/src/evidence/interfaces/Finding.md) data (ruleId, severity,
