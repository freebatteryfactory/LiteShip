...
[LiteShip](../../../README.md) / [command/src](../README.md) / CapsuleVerifyPayloadSchema

# Variable: CapsuleVerifyPayloadSchema

> `const` **CapsuleVerifyPayloadSchema**: `object`

Defined in: [command/src/commands/capsule-verify.ts:42](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/commands/capsule-verify.ts#L42)
