...
Defined in: [command/src/commands/capsule-verify.ts:47](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/commands/capsule-verify.ts#L47)
