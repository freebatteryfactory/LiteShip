...
[LiteShip](../../../README.md) / [command/src](../README.md) / ExplainDiagnostic
...
> `readonly` **area**: `"error"` \| `"cli"` \| `"gauntlet"` \| `"audit"` \| `"schema"` \| `"check"` \| `"core"` \| `"compiler"` \| `"detect"` \| `"genui"` \| `"web"` \| `"astro"` \| `"migrate"`
