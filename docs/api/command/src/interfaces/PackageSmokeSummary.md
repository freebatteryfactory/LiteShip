...
[LiteShip](../../../README.md) / [command/src](../README.md) / PackageSmokeSummary

# Interface: PackageSmokeSummary

Defined in: [command/src/registry.ts:347](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/registry.ts#L347)
...
Defined in: [command/src/registry.ts:354](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/registry.ts#L354)
