...
[LiteShip](../../../README.md) / [command/src](../README.md) / CommandMap
...
Defined in: [command/src/catalog.ts:78](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/catalog.ts#L78)
