...
Defined in: [command/src/registry.ts:700](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/registry.ts#L700)
...
[`Schema`](../../../liteship/src/schema/interfaces/Schema.md)\<`Args`, `Args`\>
