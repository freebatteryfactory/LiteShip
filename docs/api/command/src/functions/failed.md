...
[LiteShip](../../../README.md) / [command/src](../README.md) / failed

# Function: failed()

> **failed**\<`P`\>(`command`, `payload`, `exitCode?`): [`CapsuleCommandResult`](../type-aliases/CapsuleCommandResult.md)\<`P`\>

Defined in: [command/src/registry.ts:613](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/registry.ts#L613)
