...
[LiteShip](../../../README.md) / [command/src](../README.md) / capabilityUnavailable
...
Defined in: [command/src/registry.ts:630](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/command/src/registry.ts#L630)
