...
[LiteShip](../../../README.md) / [compiler/src](../README.md) / compileViewTransition

# Function: compileViewTransition()

> **compileViewTransition**(`input`): [`ViewTransitionCompileResult`](../interfaces/ViewTransitionCompileResult.md)

Defined in: [compiler/src/view-transition-compile.ts:89](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/view-transition-compile.ts#L89)
