...
Defined in: [compiler/src/token-tailwind.ts:127](https://github.com/heyoub/LiteShip/blob/main/packages/compiler/src/token-tailwind.ts#L127)
...
Compile a list of [Token.Shape](https://github.com/heyoub/LiteShip/blob/main/docs/api/core/src/namespaces/Token/type-aliases/Shape.md) into a Tailwind v4 `@theme` block.
