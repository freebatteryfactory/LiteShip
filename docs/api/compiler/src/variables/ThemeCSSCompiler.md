...
Serializes a [Theme](../../../liteship/src/type-aliases/Theme.md) into `html[data-theme="…"]` selector
...
Compile a [Theme](../../../liteship/src/type-aliases/Theme.md) into per-variant selector blocks and optional
root transitions.
