...
[LiteShip](../../../README.md) / [compiler/src](../README.md) / ARIACompileResult

# Interface: ARIACompileResult\<S\>

Defined in: [compiler/src/aria.ts:26](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/aria.ts#L26)
...
Defined in: [compiler/src/aria.ts:30](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/aria.ts#L30)
...
Defined in: [compiler/src/aria.ts:28](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/aria.ts#L28)
