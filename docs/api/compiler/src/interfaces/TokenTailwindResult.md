...
Defined in: [compiler/src/token-tailwind.ts:24](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/token-tailwind.ts#L24)
...
Defined in: [compiler/src/token-tailwind.ts:26](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/token-tailwind.ts#L26)
