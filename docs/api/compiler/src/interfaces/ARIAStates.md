...
[LiteShip](../../../README.md) / [compiler/src](../README.md) / ARIAStates
...
Defined in: [compiler/src/dispatch.ts:53](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/dispatch.ts#L53)
