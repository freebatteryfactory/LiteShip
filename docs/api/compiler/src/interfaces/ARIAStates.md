...
Defined in: [compiler/src/dispatch.ts:49](https://github.com/heyoub/LiteShip/blob/main/packages/compiler/src/dispatch.ts#L49)
...
Defined in: [compiler/src/dispatch.ts:47](https://github.com/heyoub/LiteShip/blob/main/packages/compiler/src/dispatch.ts#L47)
