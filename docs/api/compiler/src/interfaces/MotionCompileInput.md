...
[LiteShip](../../../README.md) / [compiler/src](../README.md) / MotionCompileInput
...
Defined in: [compiler/src/motion.ts:71](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/motion.ts#L71)
...
Defined in: [compiler/src/motion.ts:69](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/motion.ts#L69)
