...
[LiteShip](../../../README.md) / [compiler/src](../README.md) / MotionSpringConfig
...
Defined in: [compiler/src/motion.ts:25](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/compiler/src/motion.ts#L25)
