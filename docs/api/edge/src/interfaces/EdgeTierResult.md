...
Defined in: [edge/src/edge-tier.ts:37](https://github.com/heyoub/LiteShip/blob/main/packages/edge/src/edge-tier.ts#L37)
...
Defined in: [edge/src/edge-tier.ts:35](https://github.com/heyoub/LiteShip/blob/main/packages/edge/src/edge-tier.ts#L35)
