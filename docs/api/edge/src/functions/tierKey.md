...
[LiteShip](../../../README.md) / [edge/src](../README.md) / tierKey
...
Defined in: [edge/src/manifest.ts:63](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/edge/src/manifest.ts#L63)
...
`Pick`\<[`EdgeTierResult`](../interfaces/EdgeTierResult.md), `"motionTier"` \| `"designTier"`\>
