...
[LiteShip](../../../modules.md) / [audit/src](../README.md) / PackagePathResolution
...
Defined in: [audit/src/policy.ts:31](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/policy.ts#L31)
