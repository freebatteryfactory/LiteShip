...
Defined in: [audit/src/repo-ir-taint.ts:116](https://github.com/heyoub/LiteShip/blob/main/packages/audit/src/repo-ir-taint.ts#L116)
...
Carried into [TaintFacts.interproceduralDepth](https://github.com/heyoub/LiteShip/blob/main/packages/gauntlet/src/taint-facts.ts) so the report is self-
