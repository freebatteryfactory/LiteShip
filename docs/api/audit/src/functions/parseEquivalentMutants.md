...
[LiteShip](../../../README.md) / [audit/src](../README.md) / parseEquivalentMutants
...
Defined in: [audit/src/mutation-equivalents.ts:103](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/mutation-equivalents.ts#L103)
...
malformed entry is a tagged [ParseError](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts), never a coercion.
