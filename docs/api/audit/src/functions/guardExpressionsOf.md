...
[LiteShip](../../../README.md) / [audit/src](../README.md) / guardExpressionsOf

# Function: guardExpressionsOf()

> **guardExpressionsOf**(`node`): readonly `Expression`[]

Defined in: [audit/src/skip-detect-ast.ts:994](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/skip-detect-ast.ts#L994)
