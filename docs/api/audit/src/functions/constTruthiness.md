...
[LiteShip](../../../README.md) / [audit/src](../README.md) / constTruthiness

# Function: constTruthiness()

> **constTruthiness**(`expr`): `boolean` \| `undefined`

Defined in: [audit/src/skip-detect-ast.ts:838](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/skip-detect-ast.ts#L838)
