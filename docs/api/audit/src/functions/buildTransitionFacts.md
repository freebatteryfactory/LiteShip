...
[LiteShip](../../../README.md) / [audit/src](../README.md) / buildTransitionFacts
...
Defined in: [audit/src/transition-facts-build.ts:152](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/transition-facts-build.ts#L152)
