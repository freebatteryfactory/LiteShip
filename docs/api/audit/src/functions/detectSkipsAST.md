...
[LiteShip](../../../README.md) / [audit/src](../README.md) / detectSkipsAST

# Function: detectSkipsAST()

> **detectSkipsAST**(`source`): readonly `SkipMatch`[]

Defined in: [audit/src/skip-detect-ast.ts:104](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/skip-detect-ast.ts#L104)
