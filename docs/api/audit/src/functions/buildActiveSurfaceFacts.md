...
[LiteShip](../../../README.md) / [audit/src](../README.md) / buildActiveSurfaceFacts

# Function: buildActiveSurfaceFacts()

> **buildActiveSurfaceFacts**(`opts`): `ActiveSurfaceFacts`

Defined in: [audit/src/active-surface-reader.ts:157](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/active-surface-reader.ts#L157)
