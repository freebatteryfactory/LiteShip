...
[LiteShip](../../../README.md) / [audit/src](../README.md) / discoverInstalledPackageRoots
...
Defined in: [audit/src/consumer.ts:60](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/consumer.ts#L60)
