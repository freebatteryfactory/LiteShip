...
[LiteShip](../../../README.md) / [audit/src](../README.md) / withRepoRoot

# Function: withRepoRoot()

> **withRepoRoot**(`profile`, `repoRoot`): [`DevopsProfile`](../interfaces/DevopsProfile.md)

Defined in: [audit/src/devops-profile.ts:104](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/audit/src/devops-profile.ts#L104)
