...
Defined in: [assets/src/analysis/wav-metadata.ts:80](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/assets/src/analysis/wav-metadata.ts#L80)
