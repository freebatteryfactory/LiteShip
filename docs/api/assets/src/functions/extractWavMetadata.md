...
[LiteShip](../../../modules.md) / [assets/src](../README.md) / extractWavMetadata

# Function: extractWavMetadata()

> **extractWavMetadata**(`bytes`): [`WavMetadata`](../interfaces/WavMetadata.md)

Defined in: [assets/src/analysis/wav-metadata.ts:36](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/assets/src/analysis/wav-metadata.ts#L36)
