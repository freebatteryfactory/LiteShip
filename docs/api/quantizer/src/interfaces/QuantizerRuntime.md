...
monotonic clock is the [Clock](https://github.com/heyoub/LiteShip/blob/main/docs/api/core/src/interfaces/Clock.md) WALL boundary (`@czap/core`'s
...
advanced by `clock`: same input + a [Clock](https://github.com/heyoub/LiteShip/blob/main/docs/api/core/src/interfaces/Clock.md) of fixed time → identical
...
Defined in: [quantizer/src/quantizer.ts:199](https://github.com/heyoub/LiteShip/blob/main/packages/quantizer/src/quantizer.ts#L199)
