...
Defined in: [quantizer/src/quantizer.ts:91](https://github.com/heyoub/LiteShip/blob/main/packages/quantizer/src/quantizer.ts#L91)
...
Defined in: [quantizer/src/quantizer.ts:93](https://github.com/heyoub/LiteShip/blob/main/packages/quantizer/src/quantizer.ts#L93)
