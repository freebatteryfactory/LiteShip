...
[LiteShip](../../../README.md) / [mcp-server/src](../README.md) / ParseOutcome
...
Defined in: [mcp-server/src/jsonrpc.ts:79](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/mcp-server/src/jsonrpc.ts#L79)
