...
[LiteShip](../../../README.md) / [mcp-server/src](../README.md) / LspGauntletRunner
...
Defined in: [mcp-server/src/lsp/types.ts:77](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/mcp-server/src/lsp/types.ts#L77)
