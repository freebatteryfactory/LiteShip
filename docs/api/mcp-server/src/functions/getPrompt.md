...
Resolve a prompt by name. Unknown prompt / missing / invalid argument → [InvalidParamsError](https://github.com/heyoub/LiteShip/blob/main/packages/mcp-server/src/errors.ts) (-32602).
