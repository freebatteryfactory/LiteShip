...
[LiteShip](../../../modules.md) / [mcp-server/src](../README.md) / JsonRpcServer

# Variable: JsonRpcServer

> `const` **JsonRpcServer**: `object`

Defined in: [mcp-server/src/jsonrpc.ts:215](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/mcp-server/src/jsonrpc.ts#L215)
