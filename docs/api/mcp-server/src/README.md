...
- [LspMethodDescriptor](interfaces/LspMethodDescriptor.md)
...
- [McpMethodDescriptor](interfaces/McpMethodDescriptor.md)
...
- [McpListedResource](type-aliases/McpListedResource.md)
...
- [listMcpResources](functions/listMcpResources.md)
...
- [lspNotificationProducerMethods](functions/lspNotificationProducerMethods.md)
- [lspRoutedMethodNames](functions/lspRoutedMethodNames.md)
- [makeFrameReader](functions/makeFrameReader.md)
- [mcpAppManifest](functions/mcpAppManifest.md)
- [mcpResourceReaderUris](functions/mcpResourceReaderUris.md)
- [projectFinding](functions/projectFinding.md)
- [projectLspCapabilities](functions/projectLspCapabilities.md)
- [projectRemediation](functions/projectRemediation.md)
- [projectServerCapabilities](functions/projectServerCapabilities.md)
- [promptResolverNames](functions/promptResolverNames.md)
