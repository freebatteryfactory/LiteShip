...
[LiteShip](../../../README.md) / [web/src](../README.md) / LLMChunkNormalization

# Variable: LLMChunkNormalization

> `const` **LLMChunkNormalization**: `object`

Defined in: [web/src/stream/llm-chunks.ts:126](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/stream/llm-chunks.ts#L126)
