...
[LiteShip](../../../README.md) / [web/src](../README.md) / ToolCallAccumulator

# Type Alias: ToolCallAccumulator

> **ToolCallAccumulator** = \{ `argFragments`: `string`[]; `name`: `string`; \} \| `null`

Defined in: [web/src/stream/llm-chunks.ts:41](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/stream/llm-chunks.ts#L41)
