...
[LiteShip](../../../README.md) / [web/src](../README.md) / ChunkParser

# Type Alias: ChunkParser

> **ChunkParser** = (`event`) => [`LLMChunk`](../interfaces/LLMChunk.md) \| `null`

Defined in: [web/src/stream/llm-adapter.ts:28](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/stream/llm-adapter.ts#L28)
