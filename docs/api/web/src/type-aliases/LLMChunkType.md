...
[LiteShip](../../../README.md) / [web/src](../README.md) / LLMChunkType

# Type Alias: LLMChunkType

> **LLMChunkType** = `"text"` \| `"tool-call-start"` \| `"tool-call-delta"` \| `"tool-call-end"` \| `"done"`

Defined in: [web/src/stream/llm-chunks.ts:17](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/stream/llm-chunks.ts#L17)
