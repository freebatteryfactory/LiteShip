...
[LiteShip](../../../README.md) / [web/src](../README.md) / RuntimeUrlResolution
...
Defined in: [web/src/security/runtime-url.ts:17](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/security/runtime-url.ts#L17)
