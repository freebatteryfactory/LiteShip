...
[LiteShip](../../../README.md) / [web/src](../README.md) / OverflowPolicy

# Type Alias: OverflowPolicy

> **OverflowPolicy** = `"drop-newest"` \| `"drop-oldest"` \| `"coalesce-by-id"`

Defined in: [web/src/types.ts:229](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/types.ts#L229)
