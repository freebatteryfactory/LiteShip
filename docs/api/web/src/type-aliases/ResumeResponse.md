...
[LiteShip](../../../README.md) / [web/src](../README.md) / ResumeResponse
...
Defined in: [web/src/types.ts:367](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/types.ts#L367)
