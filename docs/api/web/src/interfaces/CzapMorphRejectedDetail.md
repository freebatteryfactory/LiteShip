...
[LiteShip](../../../modules.md) / [web/src](../README.md) / CzapMorphRejectedDetail

# Interface: CzapMorphRejectedDetail

Defined in: [web/src/wire/czap-events.ts:25](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/wire/czap-events.ts#L25)
...
Defined in: [web/src/wire/czap-events.ts:26](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/wire/czap-events.ts#L26)
