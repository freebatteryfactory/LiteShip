...
Defined in: [web/src/security/html-trust.ts:279](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/security/html-trust.ts#L279)
...
`<noscript>`, `<svg>`, `<math>`, `<style>`, `<object>`, `<embed>`, `<template>`)
