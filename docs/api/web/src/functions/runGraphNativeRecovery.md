...
[LiteShip](../../../README.md) / [web/src](../README.md) / runGraphNativeRecovery

# Function: runGraphNativeRecovery()

> **runGraphNativeRecovery**(`options`): `Promise`\<`void`\>

Defined in: [web/src/stream/recovery.ts:159](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/stream/recovery.ts#L159)
