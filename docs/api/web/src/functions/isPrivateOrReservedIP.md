...
[LiteShip](../../../README.md) / [web/src](../README.md) / isPrivateOrReservedIP

# Function: isPrivateOrReservedIP()

> **isPrivateOrReservedIP**(`hostname`): `boolean`

Defined in: [web/src/security/runtime-url.ts:187](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/security/runtime-url.ts#L187)
