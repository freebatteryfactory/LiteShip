...
[LiteShip](../../../modules.md) / [web/src](../README.md) / createAudioProcessor

# Function: createAudioProcessor()

> **createAudioProcessor**(`context`, `bridge`): `Promise`\<[`AudioProcessor`](../interfaces/AudioProcessor.md)\>

Defined in: [web/src/audio/processor-bootstrap.ts:70](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/audio/processor-bootstrap.ts#L70)
