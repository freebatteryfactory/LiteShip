...
[LiteShip](../../../README.md) / [web/src](../README.md) / resolveHtmlString

# Function: resolveHtmlString()

> **resolveHtmlString**(`html`, `options?`): `string`

Defined in: [web/src/security/html-trust.ts:328](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/web/src/security/html-trust.ts#L328)
