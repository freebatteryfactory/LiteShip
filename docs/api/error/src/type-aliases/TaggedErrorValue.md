...
[LiteShip](../../../README.md) / [error/src](../README.md) / TaggedErrorValue
...
Defined in: [error/src/contract.ts:43](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/contract.ts#L43)
