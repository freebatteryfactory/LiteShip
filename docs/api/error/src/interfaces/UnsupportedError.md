...
[LiteShip](../../../README.md) / [error/src](../README.md) / UnsupportedError
...
Defined in: [error/src/variants.ts:204](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts#L204)
...
Defined in: [error/src/variants.ts:202](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts#L202)
