...
[LiteShip](../../../README.md) / [error/src](../README.md) / DiagnosticEntry
...
> `readonly` **area**: `"gauntlet"` \| `"check"` \| `"error"` \| `"core"` \| `"schema"` \| `"audit"` \| `"compiler"` \| `"detect"` \| `"genui"` \| `"web"` \| `"astro"` \| `"cli"` \| `"migrate"`
...
Defined in: [error/src/codes.ts:84](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/codes.ts#L84)
