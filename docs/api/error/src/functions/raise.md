...
[LiteShip](../../../README.md) / [error/src](../README.md) / raise

# Function: raise()

> **raise**(`error`): `never`

Defined in: [error/src/contract.ts:146](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/contract.ts#L146)
