...
[LiteShip](../../../README.md) / [error/src](../README.md) / matchTag

# Function: matchTag()

> **matchTag**\<`E`, `R`\>(`error`, `handlers`): `R`

Defined in: [error/src/contract.ts:164](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/contract.ts#L164)
