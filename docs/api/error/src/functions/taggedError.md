...
[LiteShip](../../../README.md) / [error/src](../README.md) / taggedError
...
Defined in: [error/src/contract.ts:69](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/contract.ts#L69)
