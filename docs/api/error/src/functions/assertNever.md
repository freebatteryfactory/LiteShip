...
[LiteShip](../../../README.md) / [error/src](../README.md) / assertNever

# Function: assertNever()

> **assertNever**(`value`, `context?`): `never`

Defined in: [error/src/variants.ts:306](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts#L306)
