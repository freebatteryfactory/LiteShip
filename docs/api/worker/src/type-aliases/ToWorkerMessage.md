...
[LiteShip](../../../README.md) / [worker/src](../README.md) / ToWorkerMessage
...
Defined in: [worker/src/messages.ts:218](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/worker/src/messages.ts#L218)
