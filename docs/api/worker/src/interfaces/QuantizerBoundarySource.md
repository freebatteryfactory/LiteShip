...
Defined in: [worker/src/compositor-types.ts:63](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/worker/src/compositor-types.ts#L63)
...
Defined in: [worker/src/compositor-types.ts:65](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/worker/src/compositor-types.ts#L65)
...
Defined in: [worker/src/compositor-types.ts:67](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/worker/src/compositor-types.ts#L67)
