...
Defined in: [core/src/config.ts:152](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/config.ts#L152)
...
Defined in: [core/src/config.ts:151](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/config.ts#L151)
