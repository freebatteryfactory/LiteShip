...
[LiteShip](../../../../../modules.md) / [core/src](../../../README.md) / [TypeValidator](../README.md) / Result

# Type Alias: Result\<T\>

> **Result**\<`T`\> = `ErrorResult`\<`T`, [`ParseError`](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts)\>

Defined in: [core/src/authoring/capsule.ts:280](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/capsule.ts#L280)
