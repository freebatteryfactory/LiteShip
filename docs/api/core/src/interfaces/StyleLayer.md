...
[LiteShip](../../../README.md) / [core/src](../README.md) / StyleLayer
...
Defined in: [core/src/authoring/style.ts:38](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/style.ts#L38)
