...
[LiteShip](../../../README.md) / [core/src](../README.md) / ProjectionNode

# Interface: ProjectionNode

Defined in: [core/src/graph/document-graph.ts:112](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/document-graph.ts#L112)
...
Defined in: [core/src/graph/document-graph.ts:115](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/document-graph.ts#L115)
...
Defined in: [core/src/graph/document-graph.ts:113](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/document-graph.ts#L113)
