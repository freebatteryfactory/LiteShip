...
[LiteShip](../../../README.md) / [core/src](../README.md) / CorePluginConfig
...
Defined in: [core/src/authoring/config.ts:35](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/config.ts#L35)
