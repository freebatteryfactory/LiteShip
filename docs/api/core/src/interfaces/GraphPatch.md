...
Defined in: [core/src/graph-patch.ts:69](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/graph-patch.ts#L69)
...
Defined in: [core/src/graph-patch.ts:72](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/graph-patch.ts#L72)
