...
Defined in: [core/src/rng.ts:28](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/rng.ts#L28)
...
Defined in: [core/src/rng.ts:30](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/rng.ts#L30)
