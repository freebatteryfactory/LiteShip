...
[LiteShip](../../../modules.md) / [core/src](../README.md) / ConfigInput
...
Raw user-facing input to [defineConfig](../functions/defineConfig.md) — every field is optional.
...
Defined in: [core/src/authoring/config.ts:130](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/config.ts#L130)
