...
[LiteShip](../../../modules.md) / [core/src](../README.md) / StaggerIntentInput

# Interface: StaggerIntentInput

Defined in: [core/src/stagger.ts:41](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/stagger.ts#L41)
