...
Defined in: [core/src/projection.ts:33](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/projection.ts#L33)
...
Defined in: [core/src/projection.ts:31](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/projection.ts#L31)
