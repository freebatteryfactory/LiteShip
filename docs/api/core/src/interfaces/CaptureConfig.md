...
[LiteShip](../../../README.md) / [core/src](../README.md) / CaptureConfig
...
Defined in: [core/src/evidence/capture.ts:21](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/evidence/capture.ts#L21)
