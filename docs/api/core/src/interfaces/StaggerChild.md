...
[LiteShip](../../../modules.md) / [core/src](../README.md) / StaggerChild
...
Defined in: [core/src/stagger.ts:39](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/stagger.ts#L39)
