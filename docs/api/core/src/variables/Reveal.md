...
[LiteShip](../../../README.md) / [core/src](../README.md) / Reveal

# Variable: Reveal

> `const` **Reveal**: `object`

Defined in: [core/src/motion/reveal.ts:582](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/reveal.ts#L582)
