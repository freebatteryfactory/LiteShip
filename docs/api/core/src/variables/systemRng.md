...
[LiteShip](../../../README.md) / [core/src](../README.md) / systemRng

# Variable: systemRng

> `const` **systemRng**: [`Rng`](../interfaces/Rng.md)

Defined in: [core/src/clock/rng.ts:38](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/clock/rng.ts#L38)
