...
[LiteShip](../../../README.md) / [core/src](../README.md) / wallClock

# Variable: wallClock

> `const` **wallClock**: [`Clock`](../interfaces/Clock.md)

Defined in: [core/src/clock/clock.ts:76](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/clock/clock.ts#L76)
