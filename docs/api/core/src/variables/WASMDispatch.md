...
[LiteShip](../../../README.md) / [core/src](../README.md) / WASMDispatch

# Variable: WASMDispatch

> `const` **WASMDispatch**: [`WASMDispatchAPI`](../interfaces/WASMDispatchAPI.md)

Defined in: [core/src/wasm/wasm-dispatch.ts:226](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/wasm/wasm-dispatch.ts#L226)
