...
Defined in: [core/src/document-graph-schema.ts:206](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/document-graph-schema.ts#L206)
