...
Defined in: [core/src/capsules/graph-patch-identity.ts:174](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/capsules/graph-patch-identity.ts#L174)
