...
[LiteShip](../../../README.md) / [core/src](../README.md) / PROJECTION\_KEYS\_SOURCE
...
Defined in: [core/src/graph/projection.ts:88](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/projection.ts#L88)
