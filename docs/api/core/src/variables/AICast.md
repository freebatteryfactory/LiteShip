...
[LiteShip](../../../README.md) / [core/src](../README.md) / AICast

# Variable: AICast

> `const` **AICast**: `object`

Defined in: [core/src/authoring/ai-cast.ts:1007](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/ai-cast.ts#L1007)
