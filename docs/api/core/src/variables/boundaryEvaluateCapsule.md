...
Defined in: [core/src/authoring/capsules/boundary-evaluate.ts:101](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/capsules/boundary-evaluate.ts#L101)
