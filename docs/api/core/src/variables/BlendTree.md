...
Defined in: [core/src/blend.ts:128](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/blend.ts#L128)
...
> **make**: \<`T`\>() => `Effect`\<`BlendTreeShape`\<`T`\>, `never`, [`Scope`](https://effect-ts.github.io/effect/effect/Scope.ts.html)\> = `_make`
...
`Effect`\<`BlendTreeShape`\<`T`\>, `never`, [`Scope`](https://effect-ts.github.io/effect/effect/Scope.ts.html)\>
