...
[LiteShip](../../../README.md) / [core/src](../README.md) / CellKernel

# Variable: CellKernel

> `const` **CellKernel**: `object`

Defined in: [core/src/reactive/cell-kernel.ts:477](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/reactive/cell-kernel.ts#L477)
