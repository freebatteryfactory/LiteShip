...
Defined in: [core/src/document-graph-address.ts:154](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/document-graph-address.ts#L154)
...
rejected with ONE canonical tagged [ParseError](https://github.com/heyoub/LiteShip/blob/main/packages/error/src/variants.ts) — never silently misparsed
