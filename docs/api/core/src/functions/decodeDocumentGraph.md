...
[LiteShip](../../../README.md) / [core/src](../README.md) / decodeDocumentGraph

# Function: decodeDocumentGraph()

> **decodeDocumentGraph**(`value`): [`DocumentGraph`](../interfaces/DocumentGraph.md)

Defined in: [core/src/graph/document-graph-address.ts:182](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/document-graph-address.ts#L182)
