...
Defined in: [core/src/document-graph-address.ts:117](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/document-graph-address.ts#L117)
