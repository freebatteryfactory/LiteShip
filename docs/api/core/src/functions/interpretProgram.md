...
[LiteShip](../../../README.md) / [core/src](../README.md) / interpretProgram

# Function: interpretProgram()

> **interpretProgram**(`graph`, `program`, `env?`): [`LoweredMotionPlan`](../interfaces/LoweredMotionPlan.md)

Defined in: [core/src/motion/transition-program.ts:515](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/transition-program.ts#L515)
