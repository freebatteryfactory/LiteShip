...
[LiteShip](../../../README.md) / [core/src](../README.md) / decode

# Function: decode()

> **decode**\<`A`, `I`\>(`schema`, `input`): [`DecodeResult`](../type-aliases/DecodeResult.md)\<`A`\>

Defined in: [core/src/schema/decode.ts:242](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/decode.ts#L242)
