...
[LiteShip](../../../README.md) / [core/src](../README.md) / resolveRevealInitialState

# Function: resolveRevealInitialState()

> **resolveRevealInitialState**(`intent`, `opts`): [`StateName`](../type-aliases/StateName.md)

Defined in: [core/src/motion/reveal.ts:251](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/reveal.ts#L251)
