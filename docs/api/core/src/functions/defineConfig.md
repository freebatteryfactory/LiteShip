...
[LiteShip](../../../README.md) / [core/src](../README.md) / defineConfig

# Function: defineConfig()

> **defineConfig**(`input`): [`Config`](../interfaces/Config.md)

Defined in: [core/src/authoring/config.ts:259](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/config.ts#L259)
