...
[LiteShip](../../../README.md) / [core/src](../README.md) / applyTransition

# Function: applyTransition()

> **applyTransition**(`cellStore`, `transition`): [`StateCell`](../interfaces/StateCell.md)

Defined in: [core/src/motion/state-transition.ts:225](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/state-transition.ts#L225)
