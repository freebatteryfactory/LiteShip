...
[LiteShip](../../../README.md) / [core/src](../README.md) / compositeStateToRgba

# Function: compositeStateToRgba()

> **compositeStateToRgba**(`state`, `width`, `height`): `Uint8Array`

Defined in: [core/src/media/video.ts:152](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/media/video.ts#L152)
