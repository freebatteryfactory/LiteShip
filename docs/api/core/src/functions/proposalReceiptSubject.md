...
Defined in: [core/src/evidence/validated-output.ts:224](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/evidence/validated-output.ts#L224)
