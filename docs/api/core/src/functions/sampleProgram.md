...
[LiteShip](../../../README.md) / [core/src](../README.md) / sampleProgram

# Function: sampleProgram()

> **sampleProgram**(`plan`, `t`): readonly [`ProgramSample`](../interfaces/ProgramSample.md)[]

Defined in: [core/src/motion/transition-program.ts:680](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/transition-program.ts#L680)
