...
[LiteShip](../../../README.md) / [core/src](../README.md) / frameToT

# Function: frameToT()

> **frameToT**(`frame`, `totalFrames`): `number`

Defined in: [core/src/motion/transition-program.ts:700](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/transition-program.ts#L700)
