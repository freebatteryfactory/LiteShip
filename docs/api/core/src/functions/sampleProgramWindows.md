...
[LiteShip](../../../README.md) / [core/src](../README.md) / sampleProgramWindows

# Function: sampleProgramWindows()

> **sampleProgramWindows**(`windows`, `t`): readonly [`ProgramSample`](../interfaces/ProgramSample.md)[]

Defined in: [core/src/motion/transition-program.ts:656](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/transition-program.ts#L656)
