...
[LiteShip](../../../README.md) / [core/src](../README.md) / closestMatch

# Function: closestMatch()

> **closestMatch**(`input`, `candidates`, `threshold`): `string` \| `undefined`

Defined in: [core/src/evidence/closest-match.ts:44](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/evidence/closest-match.ts#L44)
