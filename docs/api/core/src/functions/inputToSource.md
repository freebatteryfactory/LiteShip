...
[LiteShip](../../../README.md) / [core/src](../README.md) / inputToSource

# Function: inputToSource()

> **inputToSource**(`input`): [`SignalSource`](../type-aliases/SignalSource.md) \| `undefined`

Defined in: [core/src/reactive/signal-input.ts:91](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/reactive/signal-input.ts#L91)
