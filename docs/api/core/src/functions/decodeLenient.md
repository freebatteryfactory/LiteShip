...
[LiteShip](../../../README.md) / [core/src](../README.md) / decodeLenient

# Function: decodeLenient()

> **decodeLenient**\<`A`, `I`\>(`schema`, `input`): `A` \| `null`

Defined in: [core/src/schema/decode.ts:351](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/decode.ts#L351)
