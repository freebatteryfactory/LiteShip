...
Defined in: [core/src/graph/graph-query-gap-replay.ts:288](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/graph-query-gap-replay.ts#L288)
