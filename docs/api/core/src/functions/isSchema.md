...
[LiteShip](../../../README.md) / [core/src](../README.md) / isSchema

# Function: isSchema()

> **isSchema**(`u`): `u is Schema<unknown, unknown>`

Defined in: [core/src/schema/ast.ts:250](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/ast.ts#L250)
