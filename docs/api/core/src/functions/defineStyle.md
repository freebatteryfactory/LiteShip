...
[LiteShip](../../../README.md) / [core/src](../README.md) / defineStyle

# Function: defineStyle()

> **defineStyle**\<`B`\>(`config`): `StyleDef`\<`B`\>

Defined in: [core/src/authoring/style.ts:271](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/style.ts#L271)
