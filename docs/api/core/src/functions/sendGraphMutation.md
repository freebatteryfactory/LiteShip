...
[LiteShip](../../../README.md) / [core/src](../README.md) / sendGraphMutation
...
Defined in: [core/src/graph/graph-mutation.ts:252](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/graph-mutation.ts#L252)
