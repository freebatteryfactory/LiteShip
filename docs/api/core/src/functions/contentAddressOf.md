...
Defined in: [core/src/evidence/content-address.ts:63](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/evidence/content-address.ts#L63)
