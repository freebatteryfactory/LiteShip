...
[LiteShip](../../../README.md) / [core/src](../README.md) / createGraphQueryRefreshBase
...
Defined in: [core/src/graph/graph-query.ts:333](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/graph-query.ts#L333)
