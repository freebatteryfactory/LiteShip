...
[LiteShip](../../../README.md) / [core/src](../README.md) / parseErrorFromIssues
...
Defined in: [core/src/schema/decode.ts:361](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/decode.ts#L361)
