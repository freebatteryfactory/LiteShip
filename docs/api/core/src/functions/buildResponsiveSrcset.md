...
[LiteShip](../../../README.md) / [core/src](../README.md) / buildResponsiveSrcset

# Function: buildResponsiveSrcset()

> **buildResponsiveSrcset**(`variants`, `baseWidth?`): `string`

Defined in: [core/src/media/responsive-media.ts:127](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/media/responsive-media.ts#L127)
