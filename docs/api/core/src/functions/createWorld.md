...
Defined in: [core/src/ecs.ts:216](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/ecs.ts#L216)

Build a fresh ECS [World](../interfaces/World.md) — the entity/system container that ticks systems
