...
[LiteShip](../../../README.md) / [core/src](../README.md) / rafDebounce

# Function: rafDebounce()

> **rafDebounce**(`callback`): [`RafDebouncedTrigger`](../interfaces/RafDebouncedTrigger.md)

Defined in: [core/src/reactive/scheduler.ts:187](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/reactive/scheduler.ts#L187)
