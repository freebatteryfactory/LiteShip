...
[LiteShip](../../../modules.md) / [core/src](../README.md) / tupleMap

# Function: tupleMap()

> **tupleMap**\<`T`, `U`\>(`tuple`, `fn`): \{ readonly \[K in string \| number \| symbol\]: U \}

Defined in: [core/src/internal/tuple.ts:15](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/internal/tuple.ts#L15)
