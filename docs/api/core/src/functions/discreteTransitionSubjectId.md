...
Defined in: [core/src/motion/state-transition.ts:77](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/motion/state-transition.ts#L77)
