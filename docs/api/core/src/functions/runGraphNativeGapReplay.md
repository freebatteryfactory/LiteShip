...
Defined in: [core/src/graph/graph-query-gap-replay.ts:418](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/graph-query-gap-replay.ts#L418)
