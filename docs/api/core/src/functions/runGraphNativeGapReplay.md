...
Defined in: [core/src/graph-query-gap-replay.ts:193](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph-query-gap-replay.ts#L193)
