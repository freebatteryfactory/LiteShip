...
Defined in: [core/src/graph/graph-query-gap-replay.ts:359](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/graph/graph-query-gap-replay.ts#L359)
