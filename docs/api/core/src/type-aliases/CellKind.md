...
[LiteShip](../../../modules.md) / [core/src](../README.md) / CellKind

# Type Alias: CellKind

> **CellKind** = `"boundary"` \| `"state"` \| `"output"` \| `"signal"` \| `"transition"` \| `"timeline"` \| `"compositor"` \| `"blend"` \| `"css"` \| `"glsl"` \| `"wgsl"` \| `"aria"` \| `"ai"`

Defined in: [core/src/schema/protocol.ts:17](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/protocol.ts#L17)
