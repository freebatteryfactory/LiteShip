...
[LiteShip](../../../modules.md) / [core/src](../README.md) / DocumentGraphNode

# Type Alias: DocumentGraphNode
...
Defined in: [core/src/document-graph.ts:141](https://github.com/heyoub/LiteShip/blob/main/packages/core/src/document-graph.ts#L141)
