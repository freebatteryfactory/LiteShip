...
[LiteShip](../../../README.md) / [core/src](../README.md) / ChainValidationError
...
Defined in: [core/src/evidence/receipt.ts:44](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/evidence/receipt.ts#L44)
