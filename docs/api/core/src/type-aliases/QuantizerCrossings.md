...
Defined in: [core/src/schema/quantizer-types.ts:60](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/quantizer-types.ts#L60)
