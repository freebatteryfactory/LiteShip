...
Defined in: [core/src/schema/quantizer-types.ts:49](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/schema/quantizer-types.ts#L49)
