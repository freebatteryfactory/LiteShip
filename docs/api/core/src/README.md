...
- [ASSEMBLY\_KINDS](variables/ASSEMBLY_KINDS.md)
...
- [defineCapsuleCatalog](functions/defineCapsuleCatalog.md)
...
- [inspectReceipt](functions/inspectReceipt.md)
...
- [lowerAdaptive](functions/lowerAdaptive.md)
