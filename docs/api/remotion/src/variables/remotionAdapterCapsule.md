...
Defined in: [remotion/src/capsules/remotion-adapter.ts:25](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/remotion/src/capsules/remotion-adapter.ts#L25)
