...
[LiteShip](../../../README.md) / [scene/src](../README.md) / Layout

# Variable: Layout

> `const` **Layout**: `object`

Defined in: [scene/src/sugar/layout.ts:19](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/sugar/layout.ts#L19)
