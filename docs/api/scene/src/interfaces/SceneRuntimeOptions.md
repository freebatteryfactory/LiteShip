...
Defined in: [scene/src/runtime.ts:100](https://github.com/heyoub/LiteShip/blob/main/packages/scene/src/runtime.ts#L100)
...
Defined in: [scene/src/runtime.ts:108](https://github.com/heyoub/LiteShip/blob/main/packages/scene/src/runtime.ts#L108)
