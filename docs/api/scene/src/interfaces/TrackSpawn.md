...
Defined in: [scene/src/compile.ts:40](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/compile.ts#L40)
...
Defined in: [scene/src/compile.ts:44](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/compile.ts#L44)
