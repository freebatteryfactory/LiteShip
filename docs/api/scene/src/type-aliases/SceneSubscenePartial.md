...
[LiteShip](../../../README.md) / [scene/src](../README.md) / SceneSubscenePartial

# Type Alias: SceneSubscenePartial

> **SceneSubscenePartial** = `Omit`\<[`SceneContract`](../interfaces/SceneContract.md), `"bpm"` \| `"fps"`\> & `object`

Defined in: [scene/src/include.ts:18](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/include.ts#L18)
