...
[LiteShip](../../../README.md) / [scene/src](../README.md) / SvgElementResolver

# Type Alias: SvgElementResolver

> **SvgElementResolver** = (`entityId`) => `SVGElement` \| `null` \| `undefined`

Defined in: [scene/src/systems/svg-egress.ts:63](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/systems/svg-egress.ts#L63)
