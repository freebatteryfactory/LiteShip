...
[LiteShip](../../../README.md) / [scene/src](../README.md) / ResolvedSceneContract

# Type Alias: ResolvedSceneContract

> **ResolvedSceneContract** = [`SceneContract`](../interfaces/SceneContract.md)\<`number`\> & `object`

Defined in: [scene/src/contract.ts:189](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/contract.ts#L189)
