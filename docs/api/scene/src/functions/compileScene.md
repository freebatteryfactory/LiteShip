...
[LiteShip](../../../README.md) / [scene/src](../README.md) / compileScene
...
[ValidationError](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/error/src/variants.ts) (module `'compileScene'`) listing each
