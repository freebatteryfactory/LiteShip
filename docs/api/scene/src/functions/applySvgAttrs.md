...
[LiteShip](../../../README.md) / [scene/src](../README.md) / applySvgAttrs

# Function: applySvgAttrs()

> **applySvgAttrs**(`frame`, `resolve`): `number`

Defined in: [scene/src/systems/svg-egress.ts:80](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/scene/src/systems/svg-egress.ts#L80)
