...
[LiteShip](../../../modules.md) / [liteship/src](../README.md) / defineBoundary

# Function: defineBoundary()

> **defineBoundary**\<`I`, `S`\>(`config`): `BoundaryDef`\<`I`, `S`\>

Defined in: core/dist/authoring/boundary.d.ts:147
...
prevent flicker at thresholds, and can be gated by a [BoundarySpec](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/boundary.ts) for
...
[`BoundarySpec`](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/core/src/authoring/boundary.ts)
