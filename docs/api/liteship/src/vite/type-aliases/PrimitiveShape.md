...
[LiteShip](../../../../modules.md) / [liteship/src/vite](../README.md) / PrimitiveShape

# Type Alias: PrimitiveShape\<K\>

> **PrimitiveShape**\<`K`\> = `K` *extends* `"boundary"` ? [`Boundary`](../../type-aliases/Boundary.md) : `K` *extends* `"token"` ? [`Token`](../../type-aliases/Token.md) : `K` *extends* `"theme"` ? [`Theme`](../../type-aliases/Theme.md) : [`Style`](../../type-aliases/Style.md)
