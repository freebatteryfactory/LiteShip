...
[LiteShip](../../../../README.md) / [liteship/src/graph](../README.md) / DocumentGraphNodeParts

# Type Alias: DocumentGraphNodeParts\<N\>

> **DocumentGraphNodeParts**\<`N`\> = `Omit`\<`N`, `"id"`\> & `object`

Defined in: core/dist/graph/document-graph-address.d.ts:29
...
> `readonly` `optional` **id?**: [`ContentAddress`](../../schema/type-aliases/ContentAddress.md)
