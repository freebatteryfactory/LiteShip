...
[LiteShip](../../../../README.md) / [liteship/src/graph](../README.md) / GraphPatch
...
readonly [`ReceiptEnvelope`](../../evidence/interfaces/ReceiptEnvelope.md)[]
...
> **receipt**: (`patch`, `options?`) => `Promise`\<[`ReceiptEnvelope`](../../evidence/interfaces/ReceiptEnvelope.md)\>
