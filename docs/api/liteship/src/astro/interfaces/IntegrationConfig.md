...
[LiteShip](../../../../modules.md) / [liteship/src/astro](../README.md) / IntegrationConfig

# Interface: IntegrationConfig

Defined in: astro/dist/integration.d.ts:23
...
Defined in: astro/dist/integration.d.ts:27
...
Defined in: astro/dist/integration.d.ts:43
...
Defined in: astro/dist/integration.d.ts:41
...
Defined in: astro/dist/integration.d.ts:50
...
Defined in: astro/dist/integration.d.ts:86
...
Defined in: astro/dist/integration.d.ts:69
...
Defined in: astro/dist/integration.d.ts:96
...
Defined in: astro/dist/integration.d.ts:98

Security policies applied to runtime fetch/HTML boundaries.

#### endpointPolicy?

> `readonly` `optional` **endpointPolicy?**: [`RuntimeEndpointPolicy`](../../runtime/interfaces/RuntimeEndpointPolicy.md)
...
Defined in: astro/dist/integration.d.ts:65
...
> `readonly` `optional` **vite?**: [`PluginConfig`](../../vite/interfaces/PluginConfig.md)

Defined in: astro/dist/integration.d.ts:25
...
Defined in: astro/dist/integration.d.ts:45
...
Defined in: astro/dist/integration.d.ts:60
