...
[LiteShip](../../../../modules.md) / [liteship/src/reactive](../README.md) / createStore

# Variable: createStore

> `const` **createStore**: \<`S`, `Msg`\>(`initial`, `reducer`) => `StoreShape`\<`S`, `Msg`\> & [`AsyncOwnedResource`](../interfaces/AsyncOwnedResource.md)

Defined in: core/dist/reactive/store.d.ts:57

Create a [Store](../type-aliases/Store.md) — a TEA-style state container over
[CellKernel.replay1](CellKernel.md#replay1). Build with an initial state and a pure
