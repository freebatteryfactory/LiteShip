...
[LiteShip](../../../../README.md) / [liteship/src/reactive](../README.md) / StateCell
...
> **snapshot**: (`name`, `kind`, `authority`, `state`, `stateIndex`, `dirtyEpoch`, `generation`, `value?`) => [`StateCell`](../interfaces/StateCell.md)
