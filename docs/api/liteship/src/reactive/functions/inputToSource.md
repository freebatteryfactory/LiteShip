...
[LiteShip](../../../../modules.md) / [liteship/src/reactive](../README.md) / inputToSource

# Function: inputToSource()

> **inputToSource**(`input`): [`SignalSource`](../type-aliases/SignalSource.md) \| `undefined`

Defined in: core/dist/reactive/signal-input.d.ts:62

Parse a [SignalInput](../../schema/variables/SignalInput.md) dot-string back into its typed
