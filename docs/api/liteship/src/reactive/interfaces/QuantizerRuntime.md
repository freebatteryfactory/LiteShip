...
[LiteShip](../../../../modules.md) / [liteship/src/reactive](../README.md) / QuantizerRuntime

# Interface: QuantizerRuntime

Defined in: quantizer/dist/quantizer.d.ts:133
...
instantiation, NOT in [DefineQuantizerOptions](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/quantizer/src/quantizer.ts) — so it never enters the
...
Defined in: quantizer/dist/quantizer.d.ts:139
...
Defined in: quantizer/dist/quantizer.d.ts:141
