...
[LiteShip](../../../../modules.md) / [liteship/src/reactive](../README.md) / StateCellStoreShape

# Interface: StateCellStoreShape

Defined in: core/dist/reactive/state-cell.d.ts:69

Live store — coarse authority registry over a [RuntimeCoordinator](../namespaces/RuntimeCoordinator/README.md).
