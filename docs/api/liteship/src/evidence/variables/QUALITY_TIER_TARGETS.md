...
[LiteShip](../../../../modules.md) / [liteship/src/evidence](../README.md) / QUALITY\_TIER\_TARGETS

# Variable: QUALITY\_TIER\_TARGETS

> `const` **QUALITY\_TIER\_TARGETS**: readonly `ReadonlyArray`\<[`QualityTierTarget`](../type-aliases/QualityTierTarget.md)\>[]

Defined in: core/dist/evidence/quality-tiers.d.ts:38
