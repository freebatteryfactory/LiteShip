...
[LiteShip](../../../modules.md) / [liteship/src](../README.md) / Boundary

# Type Alias: Boundary

> **Boundary** = `object`

Defined in: core/dist/authoring/boundary.d.ts:165
...
> **evaluate**: \<`B`\>(`boundary`, `value`) => `B`\[`"states"`\]\[`number`\]

Defined in: core/dist/authoring/boundary.d.ts:166
...
> **evaluateBatch**: \<`B`\>(`boundary`, `values`) => `Uint32Array`

Defined in: core/dist/authoring/boundary.d.ts:168
...
> **evaluateResult**: \<`B`\>(`boundary`, `value`, `previousState?`) => [`EvaluateResult`](../../../quantizer/src/interfaces/EvaluateResult.md)\<`B`\[`"states"`\]\[`number`\]\>

Defined in: core/dist/authoring/boundary.d.ts:167

Evaluate a value against a boundary into the rich [EvaluateResult](../../../quantizer/src/interfaces/EvaluateResult.md)
...
[`EvaluateResult`](../../../quantizer/src/interfaces/EvaluateResult.md)\<`B`\[`"states"`\]\[`number`\]\>

***

### evaluateWithHysteresis

> **evaluateWithHysteresis**: \<`B`\>(`boundary`, `value`, `previousState`) => `B`\[`"states"`\]\[`number`\]

Defined in: core/dist/authoring/boundary.d.ts:169
...
> **isActive**: \<`B`\>(`boundary`, `context?`) => `boolean`

Defined in: core/dist/authoring/boundary.d.ts:170
