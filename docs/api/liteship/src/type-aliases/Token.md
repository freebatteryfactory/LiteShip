...
[LiteShip](../../../modules.md) / [liteship/src](../README.md) / Token

# Type Alias: Token

> **Token** = `object`

Defined in: core/dist/authoring/token.d.ts:137
...
> **cssVar**: \<`N`\>(`token`) => `` `var(--liteship-${N})` ``

Defined in: core/dist/authoring/token.d.ts:139
...
> **tap**: \<`T`\>(`token`, `axisValues`) => `T`

Defined in: core/dist/authoring/token.d.ts:138
