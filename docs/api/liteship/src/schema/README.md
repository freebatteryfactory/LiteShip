...
[LiteShip](../../../README.md) / liteship/src/schema
...
- [StandardJsonSchemaProjection](interfaces/StandardJsonSchemaProjection.md)
...
- [LiteshipStandardJsonSchema](type-aliases/LiteshipStandardJsonSchema.md)
