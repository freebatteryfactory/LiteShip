...
> `const` **LITESHIP\_PACKAGES**: readonly \[`"@czap/_spine"`, `"@czap/canonical"`, `"@czap/core"`, `"@czap/genui"`, `"@czap/quantizer"`, `"@czap/compiler"`, `"@czap/web"`, `"@czap/detect"`, `"@czap/vite"`, `"@czap/astro"`, `"@czap/edge"`, `"@czap/cloudflare"`, `"@czap/worker"`, `"@czap/remotion"`, `"@czap/scene"`, `"@czap/stage"`, `"@czap/assets"`, `"@czap/audit"`, `"@czap/command"`, `"@czap/cli"`, `"@czap/mcp-server"`\]
