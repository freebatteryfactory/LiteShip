...
Defined in: [gauntlet/src/gates/transition-conformance.ts:275](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/transition-conformance.ts#L275)
...
committed ratchet. REPORT-not-DECIDE. It [requireTransition](../functions/requireTransition.md), so it runs only
