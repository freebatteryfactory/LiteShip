...
> `const` **SKIP\_CAPABILITIES**: readonly \[`"ffmpeg-absent"`, `"wasm-absent"`, `"wasm-dist-staged"`, `"shared-array-buffer-absent"`, `"coverage-instrumentation"`, `"astro-example-not-built"`, `"offscreen-canvas-absent"`, `"webcodecs-absent"`, `"gpu-absent"`, `"eacces-untestable-as-root"`, `"running-as-root"`, `"symlink-unprivileged"`, `"fixture-absent"`, `"capsule-manifest-absent"`\]
