...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / NEVER\_SIGNABLE\_WEAKENINGS
...
Defined in: [gauntlet/src/facts/standards-facts.ts:839](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L839)
