...
Defined in: [gauntlet/src/gates/composition-coverage.ts:311](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/composition-coverage.ts#L311)
