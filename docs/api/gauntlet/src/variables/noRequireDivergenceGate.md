...
Defined in: [gauntlet/src/gates/no-require-divergence.ts:37](https://github.com/heyoub/LiteShip/blob/main/packages/gauntlet/src/gates/no-require-divergence.ts#L37)
