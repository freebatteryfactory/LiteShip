...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / EvidenceChannel

# Type Alias: EvidenceChannel

> **EvidenceChannel** = `"allFiles"` \| `"ir.facts"` \| `"ir.refs"` \| [`FactChannel`](FactChannel.md)

Defined in: [gauntlet/src/evidence-recorder.ts:73](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/evidence-recorder.ts#L73)
