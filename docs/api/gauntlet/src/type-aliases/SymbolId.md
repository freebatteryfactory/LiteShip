...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / SymbolId

# Type Alias: SymbolId

> **SymbolId** = `string`

Defined in: [gauntlet/src/repo-ir.ts:46](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/repo-ir.ts#L46)
