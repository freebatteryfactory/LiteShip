...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / SiteConditionalityResolver

# Type Alias: SiteConditionalityResolver

> **SiteConditionalityResolver** = (`file`, `site`) => `SiteConditionality` \| `undefined`

Defined in: [gauntlet/src/facts/standards-facts.ts:56](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L56)
