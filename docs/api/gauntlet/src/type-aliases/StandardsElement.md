...
[LiteShip](../../../modules.md) / [gauntlet/src](../README.md) / StandardsElement
...
Defined in: [gauntlet/src/standards-facts.ts:199](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/standards-facts.ts#L199)
