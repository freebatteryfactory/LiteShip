...
Defined in: [gauntlet/src/facts/standards-facts.ts:330](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L330)
