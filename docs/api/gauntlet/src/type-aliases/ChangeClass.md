...
Defined in: [gauntlet/src/facts/standards-facts.ts:323](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L323)
