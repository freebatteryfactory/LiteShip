...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / ChangeClass

# Type Alias: ChangeClass

> **ChangeClass** = `"strengthen"` \| `"weaken"` \| `"neutral"`

Defined in: [gauntlet/src/facts/standards-facts.ts:344](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L344)
