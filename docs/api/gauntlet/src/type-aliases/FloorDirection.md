...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / FloorDirection

# Type Alias: FloorDirection

> **FloorDirection** = `"higher-is-stronger"` \| `"lower-is-stronger"`

Defined in: [gauntlet/src/facts/standards-facts.ts:165](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L165)
