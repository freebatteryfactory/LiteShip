...
Defined in: [gauntlet/src/gate.ts:650](https://github.com/heyoub/LiteShip/blob/main/packages/gauntlet/src/gate.ts#L650)

Read the injected [RepoIR](../interfaces/RepoIR.md) from a context, or throw a clear tagged
HostCapabilityError when none was injected — the guard an IR-fold gate
