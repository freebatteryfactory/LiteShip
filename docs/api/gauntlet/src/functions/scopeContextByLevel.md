...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / scopeContextByLevel

# Function: scopeContextByLevel()

> **scopeContextByLevel**(`context`, `level`, `map`, `effectiveLevels?`): [`GateContext`](../interfaces/GateContext.md)

Defined in: [gauntlet/src/engine.ts:214](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/engine.ts#L214)
