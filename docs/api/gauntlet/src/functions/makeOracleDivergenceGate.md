...
Defined in: [gauntlet/src/gates/make-oracle-divergence-gate.ts:315](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/make-oracle-divergence-gate.ts#L315)
