...
Defined in: [gauntlet/src/gates/early-return-detect.ts:113](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/early-return-detect.ts#L113)
