...
Defined in: [gauntlet/src/gate.ts:475](https://github.com/heyoub/LiteShip/blob/main/packages/gauntlet/src/gate.ts#L475)
...
throws [ValidationError](https://github.com/heyoub/LiteShip/blob/main/packages/error/src/variants.ts) at registration, not at run time).
