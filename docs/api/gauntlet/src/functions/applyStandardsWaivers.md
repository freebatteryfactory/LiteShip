...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / applyStandardsWaivers
...
Defined in: [gauntlet/src/facts/standards-facts.ts:884](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L884)
