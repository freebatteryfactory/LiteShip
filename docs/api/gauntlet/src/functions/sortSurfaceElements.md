...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / sortSurfaceElements

# Function: sortSurfaceElements()

> **sortSurfaceElements**(`elements`): readonly [`StandardsElement`](../type-aliases/StandardsElement.md)[]

Defined in: [gauntlet/src/facts/standards-facts.ts:311](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/standards-facts.ts#L311)
