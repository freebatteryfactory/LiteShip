...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / levelOf

# Function: levelOf()

> **levelOf**(`file`, `map?`): [`AssuranceLevel`](../type-aliases/AssuranceLevel.md)

Defined in: [gauntlet/src/assurance-map.ts:289](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/assurance-map.ts#L289)
