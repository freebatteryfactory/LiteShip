...
Defined in: [gauntlet/src/gates/skip-allowlist.ts:451](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/skip-allowlist.ts#L451)
