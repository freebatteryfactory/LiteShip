...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / relationSatisfied

# Function: relationSatisfied()

> **relationSatisfied**(`observed`, `admitted`): `boolean`

Defined in: [gauntlet/src/facts/spine-relation-facts.ts:139](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/facts/spine-relation-facts.ts#L139)
