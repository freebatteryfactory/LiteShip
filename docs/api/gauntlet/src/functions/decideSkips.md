...
[LiteShip](../../../README.md) / [gauntlet/src](../README.md) / decideSkips

# Function: decideSkips()

> **decideSkips**(`facts`, `decide?`): readonly [`Finding`](../interfaces/Finding.md)[]

Defined in: [gauntlet/src/gates/no-skipped-test-fact.ts:83](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/gauntlet/src/gates/no-skipped-test-fact.ts#L83)
