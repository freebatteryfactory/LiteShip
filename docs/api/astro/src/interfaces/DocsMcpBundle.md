...
[LiteShip](../../../modules.md) / [astro/src](../README.md) / DocsMcpBundle
...
Defined in: [astro/src/docs-mcp-route.ts:32](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/astro/src/docs-mcp-route.ts#L32)
