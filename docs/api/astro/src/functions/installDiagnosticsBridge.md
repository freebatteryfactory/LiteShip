...
Defined in: [astro/src/diagnostics-bridge.ts:77](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/astro/src/diagnostics-bridge.ts#L77)

Install the Astro-logger bridge as the active [Diagnostics](https://github.com/freebatteryfactory/LiteShip/blob/main/docs/api/core/src/variables/Diagnostics.md) sink and
