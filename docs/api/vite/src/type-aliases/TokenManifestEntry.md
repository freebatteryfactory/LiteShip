...
[LiteShip](../../../modules.md) / [vite/src](../README.md) / TokenManifestEntry

# Type Alias: TokenManifestEntry

> **TokenManifestEntry** = `Pick`\<[`Token`](https://github.com/freebatteryfactory/LiteShip/blob/main/docs/api/core/src/type-aliases/Token.md), `"id"` \| `"name"` \| `"category"` \| `"axes"` \| `"values"` \| `"fallback"` \| `"cssProperty"`\> & `object`
