...
[LiteShip](../../../modules.md) / [vite/src](../README.md) / Primitive

# Type Alias: Primitive\<K\>

> **Primitive**\<`K`\> = `K` *extends* `"boundary"` ? [`Boundary`](../../../liteship/src/type-aliases/Boundary.md) : `K` *extends* `"token"` ? [`Token`](../../../liteship/src/type-aliases/Token.md) : `K` *extends* `"theme"` ? [`Theme`](../../../liteship/src/type-aliases/Theme.md) : [`Style`](../../../liteship/src/type-aliases/Style.md)
