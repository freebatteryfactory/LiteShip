...
Defined in: [vite/src/boundary-manifest.ts:40](https://github.com/heyoub/LiteShip/blob/main/packages/vite/src/boundary-manifest.ts#L40)
...
Defined in: [vite/src/boundary-manifest.ts:45](https://github.com/heyoub/LiteShip/blob/main/packages/vite/src/boundary-manifest.ts#L45)
