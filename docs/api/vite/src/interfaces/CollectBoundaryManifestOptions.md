...
Defined in: [vite/src/boundary-manifest.ts:42](https://github.com/heyoub/LiteShip/blob/main/packages/vite/src/boundary-manifest.ts#L42)
...
Defined in: [vite/src/boundary-manifest.ts:47](https://github.com/heyoub/LiteShip/blob/main/packages/vite/src/boundary-manifest.ts#L47)
...
Defined in: [vite/src/boundary-manifest.ts:53](https://github.com/heyoub/LiteShip/blob/main/packages/vite/src/boundary-manifest.ts#L53)
