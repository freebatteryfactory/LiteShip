...
[LiteShip](../../../README.md) / [vite/src](../README.md) / TokenBlock
...
Defined in: [vite/src/token-transform.ts:35](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/vite/src/token-transform.ts#L35)
...
Defined in: [vite/src/token-transform.ts:33](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/vite/src/token-transform.ts#L33)
