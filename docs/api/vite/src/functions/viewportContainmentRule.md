...
[LiteShip](../../../README.md) / [vite/src](../README.md) / viewportContainmentRule

# Function: viewportContainmentRule()

> **viewportContainmentRule**(`names`, `selector?`): `string` \| `null`

Defined in: [vite/src/css-quantize.ts:568](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/vite/src/css-quantize.ts#L568)
