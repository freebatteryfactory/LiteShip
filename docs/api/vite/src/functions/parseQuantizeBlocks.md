...
[LiteShip](../../../README.md) / [vite/src](../README.md) / parseQuantizeBlocks

# Function: parseQuantizeBlocks()

> **parseQuantizeBlocks**(`css`, `sourceFile`): readonly [`QuantizeBlock`](../interfaces/QuantizeBlock.md)[]

Defined in: [vite/src/css-quantize.ts:424](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/vite/src/css-quantize.ts#L424)
