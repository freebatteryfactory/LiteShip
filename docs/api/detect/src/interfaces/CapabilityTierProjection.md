...
[LiteShip](../../../README.md) / [detect/src](../README.md) / CapabilityTierProjection
...
Defined in: [detect/src/cap-axes.ts:37](https://github.com/freebatteryfactory/LiteShip/blob/main/packages/detect/src/cap-axes.ts#L37)
