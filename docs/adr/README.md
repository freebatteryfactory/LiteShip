...
ADRs are the source of truth for _why_ a decision was made. The code is the source of truth for _what_ the current implementation looks like.
...
| 0034                                                   | _(reserved — QUERY write-sink-unreachability gate; not yet written)_        | Proposed |
...
| [0048](./0048-facade-export-budget.md)                 | The `liteship` curated facade + enforced root export budget                  | Accepted |
