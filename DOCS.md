...
| Where is the typed ECS projection/execution substrate?                       | `packages/core/src/ecs/runtime.ts`, exported only through the advanced `@liteship/core/ecs` subpath (`definePart`/`admitPart`, declared systems, Part-owned dense writers; ADR-0009)                                                                   |
