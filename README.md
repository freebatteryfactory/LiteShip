...
Pulled from the `truth-artifacts-linux` artifact of [CI run 28268276811](https://github.com/heyoub/LiteShip/actions/runs/28268276811) (commit `5f3d76f`) on 2026-06-26 (linux x64, Node 22). Refresh with `pnpm exec tsx scripts/refresh-bench-snapshot.ts` against a newer artifact, then `pnpm run docs:gen`.
