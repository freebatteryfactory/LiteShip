 ...
 * the cheap device attributes and a PROVISIONAL `data-czap-tier` before any
 ...
 * {@link DETECT_UPGRADE_SCRIPT} write `data-czap-tier`, the provisional value
 ...
 * `@czap/detect` by {@link emitProvisionalDetectScript}, which emits the SAME
...
import { emitProvisionalDetectScript } from '@czap/detect';

/**
 * Provisional head-inline detect script, DERIVED from canonical `@czap/detect`.
