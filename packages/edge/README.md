...
> [`@liteship/cloudflare`](https://github.com/freebatteryfactory/LiteShip/tree/main/packages/cloudflare)
> and [`@liteship/astro`](https://github.com/freebatteryfactory/LiteShip/tree/main/packages/astro).
...
```bash
pnpm add @liteship/cloudflare   # brings @liteship/edge with it
# direct use: pnpm add @liteship/edge
```

## 30 seconds

```ts
import { ClientHints, EdgeTier } from '@liteship/edge';
