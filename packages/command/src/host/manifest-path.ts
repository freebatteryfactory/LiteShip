 ...
 * LITESHIP_CAPSULE_MANIFEST override (CUT T1). Shared by the CLI and MCP host
...
/** Override default manifest path with `LITESHIP_CAPSULE_MANIFEST` (relative to cwd or absolute). */
