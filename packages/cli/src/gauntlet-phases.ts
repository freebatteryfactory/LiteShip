...
const RELEASE_GAUNTLET_PROJECTION: readonly PhaseProjection[] = [
  ...
  { checkId: 'check/lockfile-frozen', label: 'lockfile:gate' },
  { checkId: 'check/security-minimum', label: 'security:minimum' },
  { checkId: 'check/security-audit', label: 'security:audit' },
  { checkId: 'check/prebuild-dist-free', label: 'prebuild:gate' },
  { checkId: 'check/workflow-output-safety', label: 'workflow-output:gate' },
  { checkId: 'check/workspace-deps', label: 'workspace-deps:gate' },
  { checkId: 'check/governed-exceptions', label: 'governed-exceptions:gate' },
