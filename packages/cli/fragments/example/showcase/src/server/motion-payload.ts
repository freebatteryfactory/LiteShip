 ...
 *   - `MOTION_PAYLOAD` — the admitted directive envelope (`interpretTransition`'s
...
/** The admitted directive payload `client:motion` inlines and drives when native CSS is unavailable. */
export const MOTION_PAYLOAD: MotionDirectivePayload = {
  intent: HERO_REVEAL,
  runtime,
...
export const MOTION_PAYLOAD_JSON = serializeMotionDirectivePayload(MOTION_PAYLOAD);
