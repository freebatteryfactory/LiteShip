 ...
 * AST oracle correctly stays silent (no real legacy declaration). That
 ...
 * AST oracle — exactly the same dogfood shape as the headline default-export
 * gate, now triangulating a second property.
 *
