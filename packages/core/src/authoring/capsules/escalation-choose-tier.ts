...
import { Cap } from '../../evidence/caps.js';
import type { PolicyNode } from '../../graph/document-graph.js';
import type { CellMeta } from '../../schema/protocol.js';
import { chooseTier, tierTargets, _resetEscalationMemo } from '../../evidence/escalation.js';
