...
Bindings: **3848** across **84** public specifiers.

| Specifier | Surface | Audience | Stability | Bindings | Declaration owners | Invariant |
| --- | --- | --- | --- | ---: | ---: | --- |
| `@liteship/_spine` | advanced-module | package-author | stable | 347 | 16 | `INV-SPINE-EXACT-RELATION` |
| `@liteship/_spine/command` | advanced-module | package-author | stable | 10 | 1 | `INV-SPINE-EXACT-RELATION` |
| `@liteship/_spine/core` | advanced-module | package-author | stable | 131 | 1 | `INV-SPINE-EXACT-RELATION` |
...
| `@liteship/astro/runtime` | advanced-module | host-integrator | stable | 82 | 20 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/astro/runtime/inspector-toolbar-app` | advanced-module | host-integrator | stable | 1 | 1 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/audit` | advanced-module | operator | stable | 167 | 27 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/command` | advanced-module | operator | stable | 158 | 32 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/core` | advanced-module | package-author | stable | 466 | 110 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/core/authoring` | advanced-module | package-author | stable | 107 | 27 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/core/media` | advanced-module | package-author | stable | 35 | 9 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/core/motion` | advanced-module | package-author | stable | 82 | 12 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/detect` | advanced-module | host-integrator | stable | 35 | 7 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/edge` | advanced-module | host-integrator | stable | 41 | 7 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/error` | advanced-module | package-author | stable | 35 | 4 | `INV-DIAGNOSTIC-CODE-CLOSED` |
| `@liteship/gauntlet` | advanced-module | operator | stable | 323 | 77 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/genui` | advanced-module | package-author | experimental | 17 | 8 | `INV-PUBLIC-SURFACE-INHABITED` |
| `@liteship/mcp-server` | advanced-module | operator | experimental | 88 | 16 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/scene` | advanced-module | package-author | experimental | 68 | 22 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/vite` | advanced-module | host-integrator | stable | 51 | 14 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `@liteship/web` | advanced-module | host-integrator | stable | 126 | 29 | `INV-PUBLIC-SURFACE-INHABITED` |
...
| `liteship/media` | advanced-module | package-author | stable | 35 | 9 | `INV-FACADE-EXPORT-BUDGET` |
...
| `liteship/runtime` | advanced-module | package-author | stable | 125 | 28 | `INV-FACADE-EXPORT-BUDGET` |
