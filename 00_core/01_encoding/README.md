...
Encoding realizations must preserve canonical bytes and algorithm-qualified addresses; selecting a default digest requires interoperability and performance evidence without narrowing the algorithm-agile surface.
